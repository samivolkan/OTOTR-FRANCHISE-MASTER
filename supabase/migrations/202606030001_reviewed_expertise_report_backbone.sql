-- OTOTR reviewed migration 001: expertise report backbone.
-- Source: packages/database/raw-migrations/schema-foundations/2026-05-24-expertise-report-backbone.sql
-- Target: local Supabase/Postgres validation first.
--
-- Review adjustments:
-- - SECURITY DEFINER functions set search_path explicitly.
-- - public_report_verification is created as a security_invoker view.
--
...
create or replace view public_report_verification
