-- OTOTR reviewed migration 003: technical task ownership rules.
-- Source: packages/database/raw-migrations/rpc-functions/2026-05-24-technical-task-ownership-rules.sql
...
-- - Adds explicit execute grants/revokes for authenticated RPC use.
--
...
revoke execute on function public.log_task_audit(uuid, uuid, text, uuid, text, jsonb, jsonb) from public, anon;
