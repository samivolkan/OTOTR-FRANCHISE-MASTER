-- OTOTR reviewed migration 005: list branch technicians RPC.
-- Source: packages/database/raw-migrations/rpc-functions/2026-05-25-list-branch-technicians.sql
-- Target: local Supabase/Postgres validation first.
--
-- Review adjustments:
-- - Keeps function as constrained SECURITY DEFINER RPC.
-- - Keeps explicit execute revoke/grant.
--
